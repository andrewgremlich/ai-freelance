...
I'll share my first project as a freelance engineer and how I used AI tools, and, most importantly, how not to use AI technology. Honestly speaking, I have found AI technology to be incredibly helpful being a first-time freelance software engineer. AI Technology is useful and impressive, but if it's misused it can hinder progress as a software engineer.
